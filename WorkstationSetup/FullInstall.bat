...
@"%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -NoLogo -InputFormat None -ExecutionPolicy Bypass -File "software.ps1" 
@"%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -NoLogo -InputFormat None -ExecutionPolicy Bypass -File "Software\VSCode\installExtensions.ps1" 
